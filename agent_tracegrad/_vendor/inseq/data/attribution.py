...
class FeatureAttributionSequenceOutput(TensorWrapper, AggregableMixin):
    ...
    def show(
        ...
        **kwargs,
        ...
        """
        from agent_tracegrad._vendor.inseq import show_attributions, show_granular_attributions
    ...
    def show_granular(
        ...
        """
        from agent_tracegrad._vendor.inseq import show_granular_attributions
        ...
        **kwargs,
        ...
        Args:
            ...
            step_score_highlight (`str`, *optional*, defaults to None):
                ...
                shown. Default: None.
        """
        from agent_tracegrad._vendor.inseq import show_token_attributions
